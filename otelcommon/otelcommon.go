...
// 	protoc        v3.21.2
// source: opentelemetry-proto/proto/common/v1/common.proto
...
func (x *AnyValue) Reset() {
	*x = AnyValue{}
	if protoimpl.UnsafeEnabled {
		mi := &file_opentelemetry_proto_proto_common_v1_common_proto_msgTypes[0]
...
func (*AnyValue) Descriptor() ([]byte, []int) {
	return file_opentelemetry_proto_proto_common_v1_common_proto_rawDescGZIP(), []int{0}
}
...
func (x *ArrayValue) Reset() {
	*x = ArrayValue{}
	if protoimpl.UnsafeEnabled {
		mi := &file_opentelemetry_proto_proto_common_v1_common_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ArrayValue) Descriptor() ([]byte, []int) {
	return file_opentelemetry_proto_proto_common_v1_common_proto_rawDescGZIP(), []int{1}
}
...
func (x *KeyValueList) Reset() {
	*x = KeyValueList{}
	if protoimpl.UnsafeEnabled {
		mi := &file_opentelemetry_proto_proto_common_v1_common_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*KeyValueList) Descriptor() ([]byte, []int) {
	return file_opentelemetry_proto_proto_common_v1_common_proto_rawDescGZIP(), []int{2}
}
...
func (x *KeyValue) Reset() {
	*x = KeyValue{}
	if protoimpl.UnsafeEnabled {
		mi := &file_opentelemetry_proto_proto_common_v1_common_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*KeyValue) Descriptor() ([]byte, []int) {
	return file_opentelemetry_proto_proto_common_v1_common_proto_rawDescGZIP(), []int{3}
}
...
func (x *InstrumentationScope) Reset() {
	*x = InstrumentationScope{}
	if protoimpl.UnsafeEnabled {
		mi := &file_opentelemetry_proto_proto_common_v1_common_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*InstrumentationScope) Descriptor() ([]byte, []int) {
	return file_opentelemetry_proto_proto_common_v1_common_proto_rawDescGZIP(), []int{4}
}
...
var File_opentelemetry_proto_proto_common_v1_common_proto protoreflect.FileDescriptor

var file_opentelemetry_proto_proto_common_v1_common_proto_rawDesc = []byte{
	0x0a, 0x30, 0x6f, 0x70, 0x65, 0x6e, 0x74, 0x65, 0x6c, 0x65, 0x6d, 0x65, 0x74, 0x72, 0x79, 0x2d,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x63, 0x6f, 0x6d, 0x6d,
	...
	0x69, 0x62, 0x75, 0x74, 0x65, 0x73, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x42, 0x7b, 0x0a, 0x20, 0x69,
...
var (
	file_opentelemetry_proto_proto_common_v1_common_proto_rawDescOnce sync.Once
	file_opentelemetry_proto_proto_common_v1_common_proto_rawDescData = file_opentelemetry_proto_proto_common_v1_common_proto_rawDesc
)

func file_opentelemetry_proto_proto_common_v1_common_proto_rawDescGZIP() []byte {
	file_opentelemetry_proto_proto_common_v1_common_proto_rawDescOnce.Do(func() {
		file_opentelemetry_proto_proto_common_v1_common_proto_rawDescData = protoimpl.X.CompressGZIP(file_opentelemetry_proto_proto_common_v1_common_proto_rawDescData)
	})
	return file_opentelemetry_proto_proto_common_v1_common_proto_rawDescData
}

var file_opentelemetry_proto_proto_common_v1_common_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_opentelemetry_proto_proto_common_v1_common_proto_goTypes = []interface{}{
...
var file_opentelemetry_proto_proto_common_v1_common_proto_depIdxs = []int32{
...
func init() { file_opentelemetry_proto_proto_common_v1_common_proto_init() }
func file_opentelemetry_proto_proto_common_v1_common_proto_init() {
	if File_opentelemetry_proto_proto_common_v1_common_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_opentelemetry_proto_proto_common_v1_common_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_opentelemetry_proto_proto_common_v1_common_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_opentelemetry_proto_proto_common_v1_common_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_opentelemetry_proto_proto_common_v1_common_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_opentelemetry_proto_proto_common_v1_common_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_opentelemetry_proto_proto_common_v1_common_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_opentelemetry_proto_proto_common_v1_common_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_opentelemetry_proto_proto_common_v1_common_proto_goTypes,
		DependencyIndexes: file_opentelemetry_proto_proto_common_v1_common_proto_depIdxs,
		MessageInfos:      file_opentelemetry_proto_proto_common_v1_common_proto_msgTypes,
	}.Build()
	File_opentelemetry_proto_proto_common_v1_common_proto = out.File
	file_opentelemetry_proto_proto_common_v1_common_proto_rawDesc = nil
	file_opentelemetry_proto_proto_common_v1_common_proto_goTypes = nil
	file_opentelemetry_proto_proto_common_v1_common_proto_depIdxs = nil
}
